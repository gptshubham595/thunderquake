...
public class SettingsActivity extends AppCompatActivity {
    ...
    public static class EarthquakePreferenceFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference speclocation = findPreference(getString(R.string.settings_speclocation_key));
            bindPreferenceSummaryToValue(speclocation);

            Preference speccountlocation = findPreference(getString(R.string.settings_speccountlocation_key));
            bindPreferenceSummaryToValue(speccountlocation);
